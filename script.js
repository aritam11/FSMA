function calculatePrice() {
    ...
    console.log(((((current_usd_to_inr_rate) - usd_to_inr_rate).toFixed(2)/ usd_to_inr_rate)*100) <= -0.5)
    ...
    {
        if ((((current_usd_to_inr_rate) - usd_to_inr_rate).toFixed(2)/ usd_to_inr_rate)*100 % 1 === -0.5) {
            var adjusted_price_inr = product_price_inr + product_price_inr * Math.floor((((current_usd_to_inr_rate) - usd_to_inr_rate).toFixed(2)/ usd_to_inr_rate)*100)/100;}
        else{
